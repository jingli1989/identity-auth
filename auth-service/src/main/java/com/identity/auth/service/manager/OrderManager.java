...
import com.identity.auth.service.enums.OrderStatusEnum;
import com.identity.auth.service.model.req.BaseReqDTO;
import com.identity.auth.service.model.res.BaseResDTO;
...
public class OrderManager {
     ...
     * @return 订单信息
     */
    public TOrderInfo createOrder(BaseReqDTO baseReqDTO, String productId,int unitPrice){
       ...
       orderInfo = initOrder(baseReqDTO, productId,unitPrice);
     ...
     * @return 订单信息
     */
    private TOrderInfo initOrder(BaseReqDTO baseReqDTO, String productId,int unitPrice){
        TOrderInfo orderInfo = new TOrderInfo();
        orderInfo.setMemberId(baseReqDTO.getMemberId());
        ...
        orderInfo.setOrderMoney(unitPrice);
